...
img1 = cv2.imread('D:\Image\Dhruval\IMG_1177.jpg',-1) # -1 for alpha channels
img2 = cv2.imread('D:\Image\Dhruval\IMG_1185.jpg',0)  # 0 for gray images
img3 = cv2.imread('D:\Image\Dhruval\IMG_1229.jpg',1)  # 1 for color images
