...
# # Kernel Border Border: Kernel border border is the border of the kernel border. The kernel border border is the border of the kernel border.

# # Kernel Border Border Type: Kernel border border type is the type of border used for the kernel border. The most common border types are zero border, replicate border, and reflect border.

# # Kernel Border Border Value: Kernel border border value is the value of the border used for the kernel border. The most common border values are zero, one, and minus one.

# # Kernel Border Border Size: Kernel border border size is the size of the border used for the kernel border. The most common border sizes are one, two, and three.

# # Kernel Border Border Normalization: Kernel border border normalization is the process of dividing the kernel border border values by the sum of the kernel border border values. This ensures that the sum of the kernel border border values is equal to 1.

# # Kernel Border Border Center: Kernel border border center is the center of the kernel border border. The kernel border border center is the pixel that is being processed.

# # Kernel Border Border Anchor: Kernel border border anchor is the anchor point of the kernel border border. The kernel border border anchor is the pixel that is being processed.

# # Kernel Border Border Border: Kernel border border border is the border of the kernel border border border. The kernel border border border is the border of the kernel border border border.
...
# dilation
# To remove small black doughts on ball of mask image
kernel = np.ones((2,2), np.uint8) # It creates 4*4 ractangle
dilation = cv.dilate(mask, kernel, iterations = 3)  # above rectangle is appiled on that dought, we can change iteration accordingly
...
titles = ["Image", "Mask", "Dilation", "Erosion", "Opening", "Closing","MG", "Top Hat"]
