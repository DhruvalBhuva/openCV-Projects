...
image = cv2.line(image, (0, 0), (255, 255), (0, 0, 255), 5)  # B = 255 means blue line on img
...
image = cv2.rectangle(image, (384, 0), (510, 228), (255, 0, 0), -1)  # thickness negative values fill rectangle
...
image = cv2.putText(image, "OpenCV", (10, 500), cv2.FONT_HERSHEY_SIMPLEX, 4, (255, 255, 255), 10, cv2.LINE_AA)
